...
test.skip('Avengers: Infinity is the first top rated movie', { tag: '@movies' }, async ({
  page,
}) => {
...
test('dynamic content for first upcoming movie', { annotation: {
  type: 'issue',
  description: 'https://github.com/microsoft/playwright/issues/23180',
}, tag: '@movies' }, async ({ page }, testInfo) => {
